            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="/product/grocery?category=grocery" class="dropdown-item">식료품</a>
                        <a href="/product/supply?category=supply" class="dropdown-item">생활용품</a>
